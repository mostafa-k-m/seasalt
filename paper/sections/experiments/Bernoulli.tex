...
\begin{table}[H]
    \centering
    \begin{tabular}{>{\centering\arraybackslash}p{1.4cm}*{10}{>{\centering\arraybackslash}p{.8cm}}}
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{ccccc}
        ...
        Noise Density & MPDenoiseNet & Restormer & MPDenoiseNet & Restormer \\
        \hline
        ...
        \hline
    \end{tabular}
    \caption{Bernoulli Noise MPDenoiseNet vs. Restormer Comparison}
\end{table}

When evaluated on Bernoulli noise removal across a wide range of densities (150 to 240), MPDenoiseNet exhibits performance closely comparable to Restormer. MPDenoiseNet achieves slightly higher average PSNR scores at lower to moderate noise densities (150-220), whereas Restormer shows a marginal PSNR advantage at the highest densities (230-240). In terms of average SSIM, Restormer consistently maintains a small lead over MPDenoiseNet across all tested densities. These results suggest both models are effective, with performance varying slightly depending on the noise density and evaluation metric.