...
When evaluated on Bernoulli noise removal across a wide range of densities (150 to 240), SaltNet exhibits performance closely comparable to Restormer. SaltNet achieves slightly higher average PSNR scores at lower to moderate noise densities (150-220), whereas Restormer shows a marginal PSNR advantage at the highest densities (230-240). In terms of average SSIM, Restormer consistently maintains a small lead over SaltNet across all tested densities. These results suggest both models are effective, with performance varying slightly depending on the noise density and evaluation metric.