...
\begin{table}[H]
    ...
    \begin{tabular}{>{\centering\arraybackslash}p{1.4cm}*{10}{>{\centering\arraybackslash}p{.8cm}}}
        ...
        \hline
    \end{tabular}
    \caption{MPDNet - Bernoulli Detailed PSNR Results}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{>{\centering\arraybackslash}p{1.4cm}*{10}{>{\centering\arraybackslash}p{.8cm}}}
        ...
        \hline
    \end{tabular}
    \caption{MPDNet - Bernoulli Detailed SSIM Results}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{ccccc}
        ...
        Noise Density & MPDNet & Restormer & MPDNet & Restormer \\
        \hline
        ...
        \hline
    \end{tabular}
    \caption{Bernoulli Noise MPDNet vs. Restormer Comparison}
\end{table}

When evaluated on Bernoulli noise removal across a wide range of densities (150 to 240), MPDNet exhibits performance closely comparable to Restormer. MPDNet achieves slightly higher average PSNR scores at lower to moderate noise densities (150-220), whereas Restormer shows a marginal PSNR advantage at the highest densities (230-240). In terms of average SSIM, Restormer consistently maintains a small lead over MPDNet across all tested densities. These results suggest both models are effective, with performance varying slightly depending on the noise density and evaluation metric.