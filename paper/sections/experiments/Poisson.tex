...
In the task of Poisson noise removal, SaltNet demonstrates a significant advantage over Restormer in terms of average PSNR, consistently achieving higher scores across all tested noise densities (150 to 240). Conversely, Restormer consistently obtains slightly better average SSIM results compared to SaltNet under these conditions. This indicates that while SaltNet excels in pixel-level accuracy (PSNR) for Poisson denoising, Restormer maintains a marginal edge in preserving structural similarity (SSIM).