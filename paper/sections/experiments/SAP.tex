...
\begin{table}[H]
    ...
    \begin{tabular}{>{\centering\arraybackslash}p{1.4cm}*{10}{>{\centering\arraybackslash}p{.8cm}}}
        ...
        \hline
    \end{tabular}
    \caption{MPDNet - Detailed PSNR Salt \& Pepper Results}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{>{\centering\arraybackslash}p{1.4cm}*{10}{>{\centering\arraybackslash}p{.8cm}}}
        ...
        \hline
    \end{tabular}
    \caption{MPDNet - Detailed SSIM Salt \& Pepper Results}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{ccccc}
        ...
        \hline
    \end{tabular}
    \caption{Salt \& Pepper Noise MPDNet vs. Restormer Comparison}
\end{table}

For Salt \& Pepper noise removal, MPDNet generally outperforms Restormer across the tested noise densities (150 to 240). MPDNet achieves higher average PSNR scores for all densities except the highest (240), where performance is equal. In terms of average SSIM, MPDNet leads for densities 150 through 220, while Restormer shows a marginal advantage only at the two highest densities (230 and 240).