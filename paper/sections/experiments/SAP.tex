...
For Salt \& Pepper noise removal, SaltNet generally outperforms Restormer across the tested noise densities (150 to 240). SaltNet achieves higher average PSNR scores for all densities except the highest (240), where performance is equal. In terms of average SSIM, SaltNet leads for densities 150 through 220, while Restormer shows a marginal advantage only at the two highest densities (230 and 240).