...
Experimental results demonstrate SaltNet's competitive performance against Restormer for Gaussian noise removal across various noise levels (15, 25, 50, 60). SaltNet consistently achieves higher average PSNR scores compared to Restormer at all tested noise intensities. SaltNet also produce higher average SSIM scores at noise levels 25, 50, and 60, with Restormer holding only a marginal advantage at the lowest noise level (15).