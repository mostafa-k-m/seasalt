...
It can be concluded from this ablation study (tables \ref{table:ablation-1}, \ref{table:ablation-2}, and \ref{table:ablation-3}) that all components of SaltNet generalized well to the tested noise types. The strongest impact to denosing performance is the transformer component, followed by Unet then Seconv and Anisotropic.