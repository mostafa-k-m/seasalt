...
\begin{table}[H]
    \centering
    \begin{tabular}{>{\centering\arraybackslash}p{3.5cm}*{10}{>{\centering\arraybackslash}p{.8cm}}}
        \toprule
...
\begin{table}[H]
    \centering
    \begin{tabular}{>{\centering\arraybackslash}p{3.5cm}*{10}{>{\centering\arraybackslash}p{.55cm}}}
        \toprule
