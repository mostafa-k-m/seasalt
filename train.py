...
#     torch.load("./models/pytorch_transformers_ins`tead_of_cnn_64_36.h5", device),
# )
# train_hybrid_model(
...
# # model.load_state_dict(torch.load("./models/pytorch_restormer_4.h5", device))
# train_hybrid_model(
#         model,  # type: ignore
#         0.0003,
#         train_dataloader,
#         val_dataloader,
#         device,
#         "restormer_gauss_only_blind_5_to_60",
#         640,
#         tb_dataloader,
#     )
